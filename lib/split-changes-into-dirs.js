...
exports._filterChangedDirectories = void 0;
...
function _filterChangedDirectories(files, parentFolders, includeParent = false, depth = 1) {
...
exports._filterChangedDirectories = _filterChangedDirectories;
async function run() {
    var _a, _b, _c, _d;
    try {
